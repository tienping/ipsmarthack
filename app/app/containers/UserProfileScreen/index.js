...
import RowButton from 'components/RowButton/index';
...
import { CHECK_DOTENV, API_URL } from 'react-native-dotenv';
import { clearCartData } from 'containers/CartScreen/actions';
...
export class UserProfileScreen extends React.PureComponent { // eslint-disable-line react/prefer-stateless-function
    ...
    getUserSetting = () => (
        <View style={styles.rowDivider}>
            ...
            {/* <RowButton imageName={require('../../Resources/language.png')} title="Language" hasIcon={true} direction="right" subText="EN" /> */}
            <RowButton imageName={require('../../Resources/pass.png')} title="Change My Password" hasIcon={true} direction="right" onSelected={() => this.screenOnPressed('ResetPassword', 'RESET PASSWORD')} />
            <RowButton imageName={require('../../Resources/wishlist.png')} title="My Wishlists" hasIcon={true} direction="right" subText={dataChecking(this.props, 'profile', 'wishlist', 'total')} onSelected={() => this.screenOnPressed('WishList', 'WISHLIST')} />
            {/* <RowButton imageName={require('../../Resources/waitlist.png')} title="My Waitlists" hasIcon={true} direction="right" subText="5" /> */}
            <RowButton imageName={require('../../Resources/order.png')} title="My Orders" hasIcon={true} direction="right" subText={dataChecking(this.props, 'profile', 'order', 'total')} onSelected={() => this.screenOnPressed('OrderList', 'ORDERS')} />
            {/* <RowButton imageName={require('../../Resources/favourite.png')} title="My Favourite & Follows" hasIcon={true} direction="right" subText="5" /> */}
            {/* <RowButton imageName={require('../../Resources/notidot.png')} title="My Notification Setting" hasIcon={true} direction="right" /> */}
            <RowButton imageName={require('../../Resources/address.png')} title="My Address Book" hasIcon={true} direction="right" onSelected={() => this.screenOnPressed('AddressBook', 'ADDRESS BOOK')} />
            {/* <RowButton imageName={require('../../Resources/payment.png')} title="My Payment Method" hasIcon={true} direction="right" /> */}
        </View>
    )
    ...
    getHelpSetting = () => (
        <View style={styles.rowDivider}>
            ...
            <RowButton imageName={require('../../Resources/contact.png')} title="Contact Us" hasIcon={true} direction="right" onSelected={() => this.screenOnPressed('ContactUs', 'CONTACT US')} />
            <RowButton imageName={require('../../Resources/about.png')} title="About HERMO" hasIcon={true} direction="right" onSelected={() => this.screenOnPressed('AboutHermo', 'ABOUT HERMO')} />
            <RowButton imageName={require('../../Resources/faq.png')} title="FAQ" hasIcon={true} direction="right" onSelected={() => this.screenOnPressed('FAQ', 'FREQUENCE ASK QUESTION')} />
            <RowButton imageName={require('../../Resources/aboutpay.png')} title="About Payment" hasIcon={true} direction="right" onSelected={() => this.screenOnPressed('AboutPayment', 'ABOUT PAYMENT')} />
            <RowButton imageName={require('../../Resources/privacy.png')} title="Privacy Policy" hasIcon={true} direction="right" onSelected={() => this.screenOnPressed('PrivacyPolicy', 'PRIVACY POLICY')} />
        </View>
    )
    ...
    getContent = () => {
        ...
        return (
            <ScrollView>
                ...
                <View style={styles.rowDivider}>
                    <RowButton imageName={require('../../Resources/feedback.png')} title="Give Us Feedback" hasIcon={true} direction="right" onSelected={() => this.screenOnPressed('Feedback', 'FEEDBACK')} />
                    <RowButton imageName={require('../../Resources/joinus.png')} title="Join Us" hasIcon={true} direction="right" onSelected={() => this.screenOnPressed('JoinUs', 'JOIN US')} />
                    {/* <RowButton iconName="md-phone-portrait" title="Be a beta tester" hasIcon={true} direction="right" /> */}
                </View>
                <View style={styles.rowDivider}>
    ...
    screenOnPressed = (page, title) => {
        ...
        switch (page) {
            ...
            case 'SignOut':
                ...
                this.props.dispatch(clearCartData());
