    ...
    public void sendToNotificationCentre(Bundle bundle) {
        try {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                NotificationChannel notificationChannel = new NotificationChannel(notificationIdString, "My Notifications", NotificationManager.IMPORTANCE_HIGH);
            ...
            NotificationCompat.Builder notification = new NotificationCompat.Builder(context, notificationIdString);
